...
* **Example**: 
   * **`OFFENSIVE` Strategy**: *Parameter Composition Example*
     ...
     Multiple tactical rules are evaluated and combined to produce a **composite parameter map** for the Execution Layer.
...
* **Example**: Under the **OFFENSIVE Strategy**, the following parameters are generated:
  ...
  **`StrikerDecision`** relaxes alignment constraints and triggers earlier shots due to the `loose` kick threshold.
